      ...
      <ProjectsContainer id="projects">
        ...
        <BoxWrapper>
          ...
          >
            ...
            <ProjectP>
              This project was about building an event oriented application to
              monitor some rocket launchs{" "}
            </ProjectP>
          ...
          >
            ...
            <ProjectP>
              {" "}
              This project purpose was to monitor trains booking regarding using
              a Web and a mobile app.{" "}
            </ProjectP>
          ...
          >
            ...
            <ProjectP>
              {" "}
              This project aims to allow people with minimal knowledge to easily
              edit videos in vscode{" "}
            </ProjectP>
          ...
          >
            ...
            <ProjectP>
              {" "}
              This project purpose was to keep track of people infected by the
              Covid19{" "}
            </ProjectP>
          ...
          >
            ...
            <ProjectP>
              {" "}
              This application was built to analyze and show daily Covid data
              using charts{" "}
            </ProjectP>
          ...
          >
            ...
            <ProjectP>
              {" "}
              This project was aiming to help a company to manage deliveries
              using drones{" "}
            </ProjectP>
          ...
          >
            ...
            <ProjectP>
              {" "}
              During this project, we had to build an application to manage
              cookies sales{" "}
            </ProjectP>
          ...
          >
            ...
            <ProjectP>
              {" "}
              This appliaction was a digital version of a society game named
              Dice Forge
            </ProjectP>
            <TechnoImages src={Java} />
          </BoxCard>
      ...
      <ProjectsContainer id="educations" color={true}>
        ...
        <BoxWrapper>
          ...
          >
            ...
            <ProjectH2>
              {" "}
              Engineering cycle in computer sciences specialized in software
              architecture
            </ProjectH2>
          ...
          >
            ...
            <ProjectH2>
              {" "}
              Engineering cycle first year in computer sciences and telecoms
              field{" "}
            </ProjectH2>
          ...
          >
            ...
            <ProjectH2>
              {" "}
              Preparatory classes in mathematics, physical sciences and computer
              science{" "}
            </ProjectH2>
